...
class AppDefinitionFormatsTest extends UnitTest
  ...
  "AppDefinitionFormats" should {
    "ToJson" in {
      ...
      (r1 \ "fetch").asOpt[Seq[raml.Artifact]] should be (empty)
      ...
      (r1 \ "healthChecks").asOpt[Seq[raml.AppHealthCheck]] should be (empty)
      ...
      (r1 \ "secrets").asOpt[Map[String, raml.SecretDef]] should be (empty)
